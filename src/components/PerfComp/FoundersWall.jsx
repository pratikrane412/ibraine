  ...
  <section className="py-32 px-6 bg-white relative z-10">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
            {n: "Mukta Talani", r: "Radiant Health", t: "Professional and dedicated team. Results in record time.", i: "https://ibraine.com/media/2023/09/testimonial2.png"},
            {n: "Rohini Hans", r: "Thread Stories", t: "Talent and passion define their work. Exceeded expectations.", i: "https://ibraine.com/media/2023/09/testimonial13.png"},
            {n: "Girish More", r: "CEO", t: "The best performance marketing agency in the city.", i: "https://ibraine.com/media/2023/09/testimonial11.png"}
        ].map((t, i) => (
