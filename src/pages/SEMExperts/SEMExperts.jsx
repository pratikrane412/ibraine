...
const SEMExperts = () => {
  ...
  return (
    <main className="w-full bg-white overflow-hidden font-poppins text-[#1a1a1a]">
      ...
      <section className="py-24 px-6 bg-white text-black">
        <div className="max-w-7xl mx-auto">
           <div className="mb-12 text-center md:text-left">
             <h2 className="font-lora text-4xl lg:text-5xl mb-4">What people says</h2>
             <p className="text-gray-500 text-lg">Hear from clients who turned challenges into triumphs through our client-centric approach</p>
           </div>
           
           <div className="flex overflow-x-auto gap-6 pb-10 snap-x snap-mandatory hide-scrollbar">
              {[
                  { name: "Aman Chowdary", role: "Luxulo - Founder", img: "https://brandwitty.com/media/2023/09/testimonial2.png", text: "Sneha has done a tremendous job for us. She took our sales from 0 to 8 lakhs in the first month and from 8 lakhs to 20 lakhs in the second month. What amazing numbers! Kudos to you, Sneha. Brilliant job, team!" },
                  { name: "Salman Khan", role: "RewardPort - Business Head", img: "https://brandwitty.com/media/2023/09/testimonial13.png", text: "Sneha and her team have consistently generated high-quality leads at an amazing Cost Per Lead. After trying various agencies that failed to meet our expectations, Sneha has truly raised the bar." },
                  { name: "Rahul Pandey", role: "Synk Salon - Founder", img: "https://brandwitty.com/media/2023/09/testimonial11.png", text: "The campaigns they've crafted are not only performing exceptionally well but have also exceeded my initial expectations. I couldn't be happier with the results. Thank you, Puja and team, for your outstanding work!" }
              ].map((review, i) => (
                  <div key={i} className="min-w-[320px] md:min-w-[450px] bg-[#fcfaf2] p-8 rounded-2xl snap-center border border-gray-200">
                      <div className="flex items-center gap-4 mb-6">
                          <img src={review.img} alt={review.name} className="w-16 h-16 rounded-full object-cover border-2 border-[#FDB813]" />
                          <div>
